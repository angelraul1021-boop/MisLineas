...
export const OPERATORS: OperatorEntry[] = [
  ...
  { name: "Dalefon", status: "paused", reason: "Recaptcha bloquea peticiones desde servidor." },
  ...
  { name: "Mosi", status: "paused", reason: "Recaptcha bloquea peticiones desde servidor." },
  ...
  { name: "Oxio", status: "paused", reason: "Recaptcha bloquea peticiones desde servidor." },
  ...
  { name: "Redphone", status: "paused", reason: "Recaptcha bloquea peticiones desde servidor." },
  ...
  { name: "Tokamóvil", status: "paused", reason: "Requiere correo electrónico de registro." },
